import {NgModule, NgZone, ModuleWithProviders, InjectionToken, Inject, Optional} from '@angular/core';
...
export const WEBSTORAGE_CONFIG = new InjectionToken<string>('WEBSTORAGE_CONFIG');
